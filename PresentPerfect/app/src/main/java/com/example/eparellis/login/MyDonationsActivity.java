...
public class MyDonationsActivity extends ListActivity {
    ...
    private static String url_all_products = "http://strathpar.com/pp/view_donations_of_user.php";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Toast toast = Toast.makeText(getApplicationContext(), "Don't forget your promises!", Toast.LENGTH_LONG);
        toast.show();
        setContentView(R.layout.content_my_donations);
        Intent i = getIntent();
    ...
    class LoadAllDonations extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(MyDonationsActivity.this);
        ...
        protected String doInBackground(String... args) {
            ...
            params.add(new BasicNameValuePair("DonatorId", UserId));
            ...
            try {
                ...
                if (success == 1) {
                    ...
                    for (int i = 0; i <wishes.length(); i++) {
                        ...
                        String friend =c.getString("UserId");
            ...
            runOnUiThread(new Runnable() {
                public void run() {
                    ...
                    ListAdapter adapter = new SimpleAdapter(
                            MyDonationsActivity.this, productsList,
                            R.layout.list_main3, new String[] {TAG_PID,
                            TAG_NAME,"wishuser"},
